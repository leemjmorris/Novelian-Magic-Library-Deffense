...
#pragma warning restore CS0414
        ...
        // 마법 집중 (39034) 특수 효과: 다음 N번의 AOE 스킬 데미지 증가
        private int magicFocusRemainingCount = 0;   // 남은 AOE 스킬 횟수
        private float magicFocusDamageMultiplier = 1.0f;  // 데미지 배율 (1.5 = 50% 증가)
