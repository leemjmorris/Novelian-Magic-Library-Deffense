...
[CreateAssetMenu(fileName = "TestTable", menuName = "CSV/TestTable")]
public class TestTable : BaseCsvTable<TestData>
{
    private Dictionary<int, TestData> dataMap;
    ...
    {
        dataList = CsvUtility.LoadCsvFromText<TestData>(csvText);
        BuildDictionary();
    }
